package com.henry.auth.exceptions;

import com.henry.auth.dto.CustomErrorResponse;
...
public class GlobalHandlerException {
    ...
    public ResponseEntity<CustomErrorResponse> handleAuthenticationException(AuthenticationException e) {
            log.warn("Intento de autenticación rechazado: {}", e.getMessage());
            return ResponseEntity.status(HttpStatus.UNAUTHORIZED)
                            .body(new CustomErrorResponse(HttpStatus.UNAUTHORIZED.value(),
